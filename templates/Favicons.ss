<% cached 'Favicons', $SiteConfig.FaviconID  %>
<% if $SiteConfig.FaviconID %>
<link rel="apple-touch-icon" sizes="180x180" href="/assets/_theme/$SiteConfig.ID/apple-touch-icon.png">
...
<%--
<link rel="manifest" href="/assets/_theme/$SiteConfig.ID/site.webmanifest">
